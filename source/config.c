...
Result systems_write_example(const char *path)
{
    ...
    fputs("# LUDI-NX systems configuration.\n"
          ...
          "#\n"
          "# The sdmc:/tico paths below let an existing tico library be reused in\n"
          "# place. Adjust them if your tico install uses a different layout -\n"
          "# directories that do not exist are simply skipped.\n"
          "\n"
          "[Game Boy Advance]\n"
